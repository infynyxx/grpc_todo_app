...
public interface TodoDAO {
  @SqlUpdate("create table todos (id int primary key auto_increment, content TEXT not null, touched_ts long not null, finished boolean default false not null)")
  void createTable();
  ...
  @SqlUpdate("update todos set content = :content, touched_ts = :touched_ts, finished = :finished where id = :id")
